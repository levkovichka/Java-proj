...
public class User {
    ...
    Reader prod = new Reader("Регистрация товаров");
...
public class Reader extends JFrame {
    ...
    public Reader(String str){
        ...
        l2 = new JLabel("Описание товара");

        l3 = new JLabel("Дата поступления");

        l4 = new JLabel("Последующее обслуживание");
            ...
            try{
                ...
                try{
                    ...
                    if(k == 1)
                        ...
                        out.write("Дальнейшее обслудивание не полагается. " + "\n");

                    else if(k == -1)

                        out.write("Полагается дальнейшее обслуживание " + "\n");
